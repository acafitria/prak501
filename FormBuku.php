<?php  
require "Koneksi.php"; require "Model.php";  $judul = $penulis = $penerbit = $tahunTerbit = "";  
    ...
    <div class="container">         
        <div class="row">             
            <div class="col-md-12 py-3">                 
                ...
                <hr>                 
                <a class="btn-info btn btn-outline-succes my-2" href="Buku.php"><i class="fa fa-arrow-left"></i> Kembali</a>                 
                <div class="row">                     
                    <div class="col-md-6">                         
                        <div class="card">                         
                                        ...
                                        <div class="card-body">                         
                                            <form action="" method="post">                             
                                                ...
                                                <div class="form-group">                                 
                                                    ...
                                                    <input type="number" class="form-control" name="tahun_terbit" id="tahun_terbit" <?php echo (isset($_GET['id_buku'])) ?  "value = '" . $row[0]["tahun_terbit"] . "'" : "value = '' "; ?> placeholder="Masukan Tahun Terbit" required>                             
                                                </div>                             
                                                <?php                            
                                                if (isset($_GET['id_buku'])) {                                 
